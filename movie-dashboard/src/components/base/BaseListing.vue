<template>
    ...
    <div class="tw-mb-48 md:tw-mb-24 tw-mx-auto tw-w-10/12 tw-grid tw-grid-cols-2 lg:tw-grid-cols-4 tw-justify-items-center tw-gap-6 sm:tw-gap-12" :class="{listingOpen : backgroundStatus}">
